...
This rather rambling <a href="../pdfs/vmi_simulation.pdf" target="_blank">document </a> was the culmination of one of the worst things I've ever been asked to do in my life. I was mostly trying to find a good geometry for a velocity-map imaging spectrometer, but then ended up in a SIMION rabbit hole and it was all a fairly dark and depressing experience. Hopefully this document a) explains a bit about how VMI works; b) demonstrates that the geometry that Eppink and Parker made in the 80s is still basically fine for 99% of users; and c) helps people use SIMION (which is excellent software, looking back) and Lua without wanting to rend down their computer in a vat of acid after every work day. It's really aimed at new graduate students.
